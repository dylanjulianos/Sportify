 ...
 * Use the [admin_profile_page.newInstance] factory method to
 * create an instance of this fragment.
 */
class admin_profile_page : Fragment() {
    ...
    companion object {
         ...
         * @return A new instance of fragment admin_profile_page.
         */
        // TODO: Rename and change types and number of parameters
        @JvmStatic
        fun newInstance(param1: String, param2: String) =
            admin_profile_page().apply {
